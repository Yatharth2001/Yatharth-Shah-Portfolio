...
import Innsync from "../../Assets/Projects/Innsync.png";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={6} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Innsync"
              description="Developed a modern Next.js web application with a responsive UI using TailwindCSS and Shadcn/ui. Implemented server actions, dynamic routing, authentication with Clerk, and database integration with Supabase and Prisma. Ensured data validation using Zod and optimized performance with Vercel deployment. Designed and built reusable components, handled image uploads, and integrated CRUD functionalities. Focused on scalability, security, and best development practices."
              ghLink="https://github.com/Yatharth2001/innsync"
              demoLink="https://innsync-gamma.vercel.app/"
            />
          </Col>
          <Col md={6} className="project-card">
            <ProjectCard
          ...
          <Col md={6} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="CineChum"
              description="Designed and implemented multiple sections with current API data such as Home, Popular movies, top rated movies, upcoming movies to categorize and display movies effectively. Created a detailed movie information page showcasing movie name, duration, budget, review, earnings, genre, IMDb review, and number of reviews. Implemented a search option for users to retrieve detailed information about any movie quickly and efficiently."
          ...
          <Col md={6} className="project-card">
            <ProjectCard
              ...
              description="Retrieved user data through an API and displayed profile pictures and usernames of all relevant users. Allowed users to click on individual profiles to see detailed information including repositories, followers, following, Twitter handle, and location. Enabled navigation to GitHub link of user."
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={6} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Sparkets"
              description="Sparkets is a powerful eCommerce platform built with the MERN stack and Redux Toolkit. It now features Razorpay integration, enabling secure and seamless payment processing. Customers can easily make payments using various methods, enhancing the overall shopping experience."
